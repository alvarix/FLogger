...
define(['./workbox-3ad5617a'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.h5vemuk0g3g"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/api\.dropboxapi\.com\/.*$/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/content\.dropboxapi\.com\/.*$/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/api\.dropbox\.com\/.*$/i, new workbox.NetworkFirst({
